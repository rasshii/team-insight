...
class StandardErrorResponses:
    ...
    @staticmethod
    def unauthorized(message: str = "認証が必要です", details: Optional[List[ErrorDetail]] = None) -> Dict[str, Any]:
        """401 Unauthorizedエラー"""
        return {
            "error": {
                "code": "UNAUTHORIZED",
    ...
    @staticmethod
    def forbidden(message: str = "アクセス権限がありません", details: Optional[List[ErrorDetail]] = None) -> Dict[str, Any]:
        """403 Forbiddenエラー"""
        return {
            "error": {
                "code": "FORBIDDEN",
    ...
    @staticmethod
    def not_found(resource: str, identifier: Union[str, int], details: Optional[List[ErrorDetail]] = None) -> Dict[str, Any]:
        """404 Not Foundエラー"""
        return {
            "error": {
                "code": "NOT_FOUND",
    ...
    @staticmethod
    def validation_error(message: str = "入力値が無効です", errors: List[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    @staticmethod
    def conflict(message: str, resource: Optional[str] = None, details: Optional[List[ErrorDetail]] = None) -> Dict[str, Any]:
        """409 Conflictエラー"""
        return {
            "error": {
                "code": "CONFLICT",
    ...
    def internal_server_error(
        ...
        return {"error": error_info, "status_code": status.HTTP_500_INTERNAL_SERVER_ERROR}

    @staticmethod
    def bad_gateway(
        service: str, message: Optional[str] = None, details: Optional[List[ErrorDetail]] = None
    ) -> Dict[str, Any]:
        """502 Bad Gatewayエラー"""
    ...
    def service_unavailable(
        ...
        return {"error": error_info, "status_code": status.HTTP_503_SERVICE_UNAVAILABLE}
